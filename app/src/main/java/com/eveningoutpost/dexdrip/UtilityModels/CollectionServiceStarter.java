...
public class CollectionServiceStarter {
    ...
    private void start(Context context, String collection_method) {
        ...
        if (isBTWixelOrLimiTTer(collection_method) || isDexbridgeWixel(collection_method)) {
            ...
            if (DexCollectionType.hasBluetooth() || DexCollectionType.getDexCollectionType() == NSFollow || DexCollectionType.getDexCollectionType() == SHFollow || DexCollectionType.getDexCollectionType() == CLFollow) {
